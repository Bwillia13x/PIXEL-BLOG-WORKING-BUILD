...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Advanced financial trading dashboard with real-time market data simulation, portfolio management, and technical analysis indicators. A comprehensive trading platform featuring real-time price updates, portfolio tracking with P&L calculations, interactive candlestick charts, technical indicators (RSI, MACD, Moving Averages, Bollinger Bands), and a professional financial UI.",
    tags: ["Financial Technology", "Real-time Data", "Technical Analysis", "JavaScript"],
    year: 2025,
    status: "completed",
    demo: "/projects/trading-dashboard/index.html",
    github: "https://github.com/Bwillia13x/PixelProjects_v1",
    featured: true
  },
  {
    id: "3d-data-engine",
    title: "3D Data Visualization Engine",
    description: "Interactive 3D data visualization platform with WebGL rendering, supporting multiple visualization types and large dataset exploration. A powerful 3D visualization engine built with Three.js and WebGL, featuring point clouds, network graphs, mathematical surfaces, and data clusters with real-time controls and 60 FPS performance.",
    tags: ["Data Visualization", "WebGL", "3D Graphics", "Three.js"],
    year: 2025,
    status: "completed",
    demo: "/projects/3d-data-engine/index.html",
    github: "https://github.com/Bwillia13x/PixelProjects_v1",
    featured: true
  }
]
