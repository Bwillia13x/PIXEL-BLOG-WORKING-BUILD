import "./globals.css"
import { Press_Start_2P, VT323, JetBrains_Mono, Inter } from "next/font/google"
...
export default function RootLayout({
  ...
  return (
    ...
    >
      ...
      <body
        className={`${pressStart2P.variable} ${vt323.variable} ${jetBrainsMono.variable} ${inter.variable} font-sans bg-black text-green-400 antialiased selection:bg-green-400 selection:text-gray-900 matrix-background`}
        suppressHydrationWarning
      >
              ...
              <SEOLayout>
                <AppWrapper>
                  ...
                  <div className="relative z-10">
                    ...
                    <main 
                      id="main-content"
                      className="relative z-10 bg-black/80 backdrop-blur-sm rounded-lg space-p-responsive pt-44 sm:pt-48 lg:pt-56 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto focus:outline-none focus:ring-2 focus:ring-green-400 border border-green-400/20"
                      role="main"
